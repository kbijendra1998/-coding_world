...
<form action='https://crm.zoho.in/crm/WebToLeadForm' name=WebToLeads249769000000315288 method='POST' onSubmit='javascript:document.charset="UTF-8"; return checkMandatory249769000000315288()' accept-charset='UTF-8'>
<input type='text' style='display:none;' name='xnQsjsdp' value='db887390625950606c3528f7d8a1164e30435b00b138096d0b5552f3dbf2ced5'></input> 
<input type='hidden' name='zc_gad' id='zc_gad' value=''></input> 
<input type='text' style='display:none;' name='xmIwtLD' value='d76885641456a663d57cccfa02d3eb211e5b76cdfb9062ccef64d3fad2c26bd7'></input> 
<input type='text'  style='display:none;' name='actionType' value='TGVhZHM='></input>
<input type='text' style='display:none;' name='returnURL' value='https&#x3a;&#x2f;&#x2f;crm.zoho.in&#x2f;crm&#x2f;org60010990594&#x2f;tab&#x2f;Leads' > </input>
...
<div class='zcwf_row'>
   ...
   <div class='zcwf_col_fld'>
      <input type='text' id='Company' name='Company' maxlength='100'></input>
      <div class='zcwf_col_help'></div>
   </div>
</div>
<div class='zcwf_row'>
   ...
   <div class='zcwf_col_fld'>
      ...
      <div class='zcwf_col_help'>
         <span title='example&#x40;gmail.com' style='cursor: pointer; width: 16px; height: 16px; display: inline-block; background: #fff; border: 1px solid #ccc; color: #ccc; text-align: center; font-size: 11px; line-height: 16px; font-weight: bold; border-radius: 50%;' onclick='tooltipShow249769000000315288(this)'>?</span>
         <div class='zcwf_tooltip_over' style='display: none;'><span class='zcwf_tooltip_ctn'>example&#x40;gmail.com</span></div>
      </div>
   </div>
</div>
<div class='zcwf_row'>
...
<script>
   function validateEmail249769000000315288()
   {
   	var form = document.forms['WebToLeads249769000000315288'];
   	...
   	return true;
   	  ...
   	  function checkMandatory249769000000315288() {
   	...
   	for(i=0;i<mndFileds.length;i++) {
   	  var fieldObj=document.forms['WebToLeads249769000000315288'][mndFileds[i]];
   	  if(fieldObj) {
   	...
   	if(!validateEmail249769000000315288()){return false;}
   	document.querySelector('.crmWebToEntityForm .formsubmit').setAttribute('disabled', true);
   }
   
   function tooltipShow249769000000315288(el){
